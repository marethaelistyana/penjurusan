...
$aksi="modul/mod_kepsek/aksi_kepsek.php";
switch($_GET[act]){
  // Tampil User
  default:
  echo "
	<div class=''>
          ...
          echo"
          <input type=button class='btn btn-primary' value='Tambah' onclick=\"window.location.href='?module=staf&act=tambahkepsek';\">
              <p>";
        }
        echo"
                    <table id='datatable-keytable' class='table table-striped table-bordered'>
                      ...
                      <tbody>";
					if ($_SESSION['leveluser']=='admin'){
					$tampil = mysqli_query($konek,"SELECT * FROM tabel_login WHERE level='kepsek' ORDER BY id ASC");
					}
					else {
					...
					while ($r=mysqli_fetch_array($tampil)){
                        ...
                        <tr>
                          ...
                          <td><a href=?module=kepsek&act=editkepsek&id=$r[id] class='btn btn-primary btn-sm' title='Edit'><i class='fa fa-edit'></i></a>";
							if ($_SESSION['leveluser']=='admin'){
							echo"
	                      <a href=$aksi?module=kepsek&act=hapus&id=$r[id] class='btn btn-danger btn-sm' title='Hapus' onClick=\"return confirm('Apakah Anda Yakin Untuk Menghapus Data Ini ?')\"><i class='fa fa-trash'></i></a>";
						  }
						  echo"</td>
                        </tr>";
						$no++;
	...
	<div class=''>
            ...
            <div class='row'>
                ...
                <div class='x_panel'>
                  ...
                  <div class='x_content'>
                    <br />
                    <form id='form1' method=POST action='$aksi?module=kepsek&act=input' data-parsley-validate class='form-horizontal form-label-left'>
  ...
  case "editkepsek":
	...
	<div class=''>
            ...
            <div class='row'>
                ...
                <div class='x_panel'>
                  <div class='x_title'>
                    <h2>Form Edit Kepala Sekolah</h2>
                    <ul class='nav navbar-right panel_toolbox'>
                      <li><a class='collapse-link'><i class='fa fa-chevron-up'></i></a>
                      </li>
                      <li class='dropdown'>
                  ...
                  <div class='x_content'>
                    <br />
                    <form id='form2' method=POST action='$aksi?module=kepsek&act=update' data-parsley-validate class='form-horizontal form-label-left'>
