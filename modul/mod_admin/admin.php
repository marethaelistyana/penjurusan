                ...
                <div class='x_panel'>
				  ...
				  <input type=button class='btn btn-primary' value='Tambah' onclick=\"window.location.href='?module=admin&act=tambahadmin';\">
                    ...
                    <table id='datatable-keytable' class='table table-striped table-bordered'>
                      ...
                      <tbody>";
					$tampil = mysqli_query($konek,"SELECT * FROM tabel_login WHERE level='admin' ORDER BY id ASC");
					$no=1;
					while ($r=mysqli_fetch_array($tampil)){
                        ...
                        <tr>
                          ...
                          <td><a href=?module=admin&act=editadmin&id=$r[id] class='btn btn-primary btn-sm' title='Edit'><i class='fa fa-edit'></i></a>
	                      <a href=$aksi?module=admin&act=hapus&id=$r[id] class='btn btn-danger btn-sm' title='Hapus' onClick=\"return confirm('Apakah Anda Yakin Untuk Menghapus Data Ini ?')\"><i class='fa fa-trash'></i></a></td>
                        </tr>";
						$no++;
						}
                        echo"
	...
	<div class=''>
            ...
            <div class='row'>
                ...
                <div class='x_panel'>
                  ...
                  <div class='x_content'>
                    <br />
                    <form id='form1' method=POST action='$aksi?module=admin&act=input' data-parsley-validate class='form-horizontal form-label-left'>
	...
	<div class=''>
            ...
            <div class='row'>
                ...
                <div class='x_panel'>
                  ...
                  <div class='x_content'>
                    <br />
                    <form id='form2' method=POST action='$aksi?module=admin&act=update' data-parsley-validate class='form-horizontal form-label-left'>
